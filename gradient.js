...
class Gradient {
  ...
  /**
   * Creates a palette from the color's generated by supplying a 2D vector
   * rotated around the z axis to Color#fromDir2 .
   *
   * This gradient is periodic, as it begins and ends with (1.0, 0.5, 0.5, 1.0)
   * .
   *
   * @param {Gradient} target the output gradient
   * @returns the gradient
   */
  static paletteDir2 (target = new Gradient()) {

    target.keys = [
      new ColorKey(0.000000, new Color(1.000000, 0.500000, 0.5)),
      new ColorKey(0.066667, new Color(0.956773, 0.703368, 0.5)),
      new ColorKey(0.166667, new Color(0.834565, 0.871572, 0.5)),
      new ColorKey(0.200000, new Color(0.654508, 0.975528, 0.5)),
      new ColorKey(0.266667, new Color(0.447736, 0.997261, 0.5)),
      new ColorKey(0.333333, new Color(0.250000, 0.933013, 0.5)),
      new ColorKey(0.400000, new Color(0.095491, 0.793893, 0.5)),
      new ColorKey(0.466667, new Color(0.010926, 0.603956, 0.5)),
      new ColorKey(0.533333, new Color(0.010926, 0.396044, 0.5)),
      new ColorKey(0.600000, new Color(0.095491, 0.206107, 0.5)),
      new ColorKey(0.666667, new Color(0.250000, 0.066987, 0.5)),
      new ColorKey(0.733333, new Color(0.447736, 0.002739, 0.5)),
      new ColorKey(0.800000, new Color(0.654508, 0.024472, 0.5)),
      new ColorKey(0.866667, new Color(0.834565, 0.128428, 0.5)),
      new ColorKey(0.933333, new Color(0.956773, 0.296632, 0.5)),
      new ColorKey(1.000000, new Color(1.000000, 0.500000, 0.5))
    ];
